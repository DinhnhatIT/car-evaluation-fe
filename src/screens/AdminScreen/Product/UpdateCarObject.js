...
const UpdateCarObject = () => {
  ...
  useEffect(() => {
    axios.get(`https://car-evaluation-be.tripllery.com/getCar/${id}`)  // Use 'id' in the GET request
      .then((res) => {
  ...
  const handleSubmit = (event) => {
    ...
    try {
      axios.put(`https://car-evaluation-be.tripllery.com/updateCar/${id}`, inputData)  // Use 'id' in the PUT request
        .then(res => {
