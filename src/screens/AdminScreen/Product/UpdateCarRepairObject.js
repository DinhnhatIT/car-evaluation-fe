...
const UpdateCarRepairObject = () => {
  ...
  useEffect(() => {
    axios.get(`https://car-evaluation-be.tripllery.com/car/getCarRepair/${id}`)  // Use 'id' in the GET request
      .then((res) => {
  ...
  const handleSubmit = (event) => {
    ...
    try {
      axios.put(`https://car-evaluation-be.tripllery.com/car/updateCarRepair/${id}`, inputData)  // Use 'id' in the PUT request
        .then(res => {
